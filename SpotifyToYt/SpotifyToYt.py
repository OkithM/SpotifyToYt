...
SPOTIPY_CLIENT_ID = '' # You can find this in Spotify Developer Dashboard
SPOTIPY_CLIENT_SECRET = '' # You can find this in Spotify Developer Dashboard
SPOTIPY_REDIRECT_URI = 'http://127.0.0.1:8888/callback'

# The ID of the Spotify playlist you want to get songs from
PLAYLIST_ID = '' # Copy from Playist link
...
print(f"Fetching songs from playlist ID: {PLAYLIST_ID}")
